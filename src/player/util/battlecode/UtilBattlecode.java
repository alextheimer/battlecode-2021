...
public class UtilBattlecode {
	...
	public static class IllegalGameActionException extends RuntimeException {
		 ...
		 */
		public IllegalGameActionException(final GameActionException e) {
			super(IllegalGameActionException.makeMessage(e));
		}

		private static String makeMessage(final GameActionException e) {
	 ...
	 */
	public static Stream<MapLocation> makeAllAdjacentMapLocStream(final MapLocation mapLoc) {
		return Arrays.stream(UtilBattlecode.OFF_CENTER_DIRECTIONS).map(dir -> mapLoc.add(dir));
	}
	 ...
	 */
	public static <T> Predicate<T> silenceGameActionPredicate(final GameActionPredicate<T> pred) {
	...
	public static void log(final String logString) {
		...
		UtilBattlecode.LOG_STREAM.println(logString);
	}
	 ...
	 */
	public static DoubleVec2D mapLocToVec(final MapLocation mapLoc) {
